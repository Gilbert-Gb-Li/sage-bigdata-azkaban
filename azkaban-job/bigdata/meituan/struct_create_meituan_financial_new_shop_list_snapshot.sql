CREATE EXTERNAL TABLE `bigdata.meituan_financial_new_shop_list_snapshot`(
  `restaurant_id` string COMMENT '商家经纬名',
...
ROW FORMAT DELIMITED
  ...
  LINES TERMINATED BY '\n'
  STORED AS ORC
  LOCATION '/data/meituan/snapshot/meituan_financial_add_shop_list';