CREATE EXTERNAL TABLE IF NOT EXISTS `bigdata.copyrightcloud_secphoto_new_comment_detail_snapshot` (
  ...
  ROW FORMAT DELIMITED
	...
	LINES TERMINATED BY '\n'
	STORED AS ORC
	LOCATION '/data/copyrightcloud/secphoto/snapshot/new_comment_detail/';