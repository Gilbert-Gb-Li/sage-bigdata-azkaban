CREATE EXTERNAL TABLE IF NOT EXISTS `bigdata.copyrightcloud_secphoto_all_comment_detail_snapshot` (
  ...
  ROW FORMAT DELIMITED
	...
	LINES TERMINATED BY '\n'
	STORED AS ORC
	LOCATION '/data/copyrightcloud/secphoto/snapshot/all-short-video-comment/';