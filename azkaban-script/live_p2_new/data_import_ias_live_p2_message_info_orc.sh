...
echo '#################  直播间消息快照表 start  ########################'
    ...
    insert_sql_1="INSERT INTO TABLE ias_p2.tbl_ex_live_message_info_orc PARTITION(dt='${day}',hour='${hour}')
        ...
        FROM (
            ...
            FROM ias_p2.tbl_ex_live_danmu_data_origin_orc as t
            LATERAL VIEW explode(message_info) r1 AS message WHERE dt='${day}' AND hour='${hour}' AND message_info IS NOT NULL
        ) as f ; "


    insert_sql_2="INSERT INTO TABLE ias_p2.tbl_ex_live_message_info_orc PARTITION(dt='${day}',hour='${hour}')
        ...
        from default.tmp_gift_p4 where gift_count<=0 or gift_count is null or (gift_count>0 and gift_id='0'); "
