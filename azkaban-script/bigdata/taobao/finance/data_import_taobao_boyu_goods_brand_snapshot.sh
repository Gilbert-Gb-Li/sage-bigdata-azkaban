...
hive_sql="
INSERT INTO table bigdata.taobao_boyu_goods_brand_snapshot PARTITION(dt='${date}')
select
      brand,
...
where dt >= '${date_reduce_6}' and dt <= '${date}'   and isNotBrand=0 and isNotExit=0
) t
where t.order_num = 1
group by t.brand
;"
...
insert into bigdata.taobao_boyu_goods_brand_es_data
select
      ...
      avg_price1,
      avg_price2
from bigdata.taobao_boyu_goods_brand_snapshot
where dt = '${date}'
;"
