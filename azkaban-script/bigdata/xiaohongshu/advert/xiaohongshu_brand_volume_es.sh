#!/bin/bash
#***********************************************************************************
# **  文件名称: xiaohongshu_brand_volume_es.sh
# **  创建日期: 2018年10月25日 
# **  编写人员: zsk
# 
# **  输入信息: 
...
#表名称
LOGNAME="xiaohongshu_brand_volume_es"
...
insert overwrite table bigdata.xiaohongshu_brand_volume_es partition
  (CYCLE, dt) 
select regexp_replace('${DAY_ID}', '-', '') stat_month, -- 月
	   ...
	   cycle,
	   dt
  from bigdata.xiaohongshu_brand_volume
 where dt = '${DAY_ID}';
"
