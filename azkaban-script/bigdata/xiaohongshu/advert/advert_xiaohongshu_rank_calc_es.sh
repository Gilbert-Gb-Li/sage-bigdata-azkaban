#!/bin/bash
#***********************************************************************************
# **  文件名称: advert_xiaohongshu_rank_calc_es.sh
# **  创建日期: 2018年10月25日 
# **  编写人员: zsk
# 
# **  输入信息: 
...
#表名称
LOGNAME="advert_xiaohongshu_rank_calc_es"
...
insert overwrite table bigdata.advert_xiaohongshu_rank_calc_es partition(cycle,dt)
...
cycle,  -- 统计周期
dt  -- 统计数据日期（分区字段）
from bigdata.xiaohongshu_advert_rank_calc_data
where dt='${DAY_ID}';
"
RunScript "${SQL}"
