...
hive_sql="
INSERT INTO table bigdata.tmall_boyu_goods_statistics_snapshot PARTITION(dt='${date}')
select
...
(
    ...
    from bigdata.tmall_boyu_shop_all_snapshot
    where dt = '${date}'
    UNION ALL
    select
    ...
    select
          ...
          0 as goods_trade_amount_low,
          0 as goods_trade_amount_high
    from bigdata.tmall_boyu_shop_new_snapshot
    ...
    select
          ...
          0 as goods_trade_amount_low,
          0 as goods_trade_amount_high
    from bigdata.tmall_boyu_goods_new_snapshot
    where dt >= '${date_reduce_6}' and dt <= '${date}'
) t
;"
...
insert into bigdata.tmall_boyu_goods_statistics_es_data
select
...
from bigdata.tmall_boyu_goods_statistics_snapshot
where dt = '${date}'
;"
