...
tmp_mysql_remain_table="tmp_tbl_report_live_daily_data_remain_data"
...
FROM (
    ...
    FROM live.tbl_ex_anchor_new_snapshot
...
SET a.next_remain=b.remain_count
...
ON a.stat_date=b.stat_date AND a.biz_name=b.biz_name AND a.data_source = b.data_source
SET a.third_remain=b.remain_count
...
ON a.stat_date=b.stat_date AND a.biz_name=b.biz_name AND a.data_source = b.data_source
SET a.seven_remain=b.remain_count
